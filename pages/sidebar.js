...
const Sidebar = () => {
    ...
    const [isSidebarOpen, setIsSidebarOpen] = useState(false); // Nueva variable de estado para controlar la apertura del menú en dispositivos móviles
                    ...
                    <ul className="space-y-2 font-medium">
                        {isAdmin && (
                            <>
                                ...
                                <li>
                                    <a href="/admin/tarjetasVinculadas" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                                        <svg class="w-6 h-6 text-gray-500 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
